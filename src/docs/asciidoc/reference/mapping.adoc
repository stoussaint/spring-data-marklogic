...
When dealing with content from/to Marklogic a `MarklogicConverter` come into play to perform actually perform conversion operation from the Marklogic Content API to the domain Entity class to use.
